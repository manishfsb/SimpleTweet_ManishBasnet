...
- [x] Implemented a taskbar instead of the ActionBar
- [x] Can hide the ActionBar while composing a tweet
- [x] Replaced project title with twitter icon and compose button with a different icon.
- [x] App has rounded profile images just like Twitter.
- [x] Dark mode for the login screen and different themes for the other screens.
...
- [x] User can differentiate the tweet and the username as different font styles have been implemented
...
- [ ] Change the display picture to a circled layout
